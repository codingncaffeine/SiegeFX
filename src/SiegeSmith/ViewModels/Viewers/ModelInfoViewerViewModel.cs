...
public sealed class ModelInfoViewerViewModel : ObservableObject
{
    ...
    private void Render()
    {
        ...
        var bgra = _textured && CanTexture && !_wireframe
            ? SoftwareRenderer.RenderTextured(_verts, _normals, _uvs, _triTex, _textures, _vw, _vh, _center, _radius, _yaw, _pitch, _dist)
            : SoftwareRenderer.Render(_verts, _normals, _vw, _vh, _center, _radius, _yaw, _pitch, _dist, _wireframe);
